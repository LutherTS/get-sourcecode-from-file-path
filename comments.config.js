const data = {
  jsDoc: Object.freeze({
    ...
    params: Object.freeze({
      absolutePath:
        "The absolute path of the file." /* $COMMENT#JSDOC#PARAMS#ABSOLUTEPATH */,
      options:
    ...
    returns: Object.freeze({
      getSourceCodeFromFilePath:
        "The ESLint-generated `SourceCode` object of the file, from which the AST (`sourceCode.ast`) and all comments (`sourceCode.getAllComments()`) can be extracted. `null` when encountering fatal syntax." /* $COMMENT#JSDOC#RETURNS#GETSOURCECODEFROMFILEPATH */,
    }),
  }),
};
